...
from gold_bot.brokers.bitvavo import ACTIFS, marche
...
class TestPlafondJournalierIllimite:
    ...
    def test_la_config_du_robot_est_bien_sans_plafond(self):
        """robot.spot.json a disparu avec le broker spot : c'est la
        configuration reellement en service qui doit porter la garantie."""
        from gold_bot.settings import BotConfig
        assert BotConfig.load("robot.bitvavo.json").risk.max_daily_trades == 0
