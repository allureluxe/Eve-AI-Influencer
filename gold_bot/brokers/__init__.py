...
from .coinbase import CoinbaseBroker, CoinbaseConfig, CoinbaseProductRule
...
class _ObsoleteBroker(Broker):
    name = "obsolete"
    is_live = False
    def __init__(self, *args, **kwargs): raise BrokerError("Ce broker a ete retire. Utilisez Bitvavo, Coinbase ou Pionex.")
...
class _ObsoleteConfig:
    @classmethod
    def from_env(cls): raise BrokerError("Configuration obsolete. Utilisez Bitvavo, Coinbase ou Pionex.")
...
__all__ = [
    "Broker", "BrokerError", "AccountInfo", "PaperBroker", "PaperConfig",
    "BitvavoBroker", "BitvavoConfig", "RegleMarche", "CoinbaseBroker", "CoinbaseConfig", "CoinbaseProductRule",
    "PionexBroker", "PionexConfig", "PionexMarketRule", "PionexFuturesBroker", "PionexFuturesConfig", "PionexFuturesRule",
